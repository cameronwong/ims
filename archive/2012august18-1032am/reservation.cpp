...
Reservation::Reservation(quint32 itemID, QDateTimeSpan &timePeriod, QMoney price, quint32 customerID,
                         quint8 paymentMethod, quint8 location, quint16 employeeID)
{
    _myID = _currID++;
